        ...
        function DirectiveController($scope, $element, $attrs) {
            ...
            function hourModelFactory(milliseconds) {
                ...
                for (var i = 0; i < 24; i += 1) {
                    var hourMoment = moment.utc(selectedDate).add(i, 'hours').locale('en-gb');
                    var dateValue = {
            ...
            function minuteModelFactory(milliseconds) {
                ...
                var minuteFormat = 'YYYY-MM-DD HH:mm'
                ...
                for (var i = 0; i < limit; i += 1) {
                    var hourMoment = moment.utc(selectedDate).add(i * configuration.minuteStep, 'minute').locale('en-gb');
                    var dateValue = {
